...
export default class PasswordVC extends React.Component {
    ...
    async UpdatePW() {
        ...
        let RequestURL = "https://" + this.getServerAddr() + "/api/v1beta/login?";
            ...
            <Modal animationType={'slide'} transparent={false} visible={isShow}>
                ...
                <KeyboardAvoidingView
                    ...
                    <HeaderBar
                        ...
                        rightIcon={<Text style={{color: 'white', fontSize: 15}}>Close</Text>}
                        onRightButton={() => {
                            this.onTapClose()
                        }}
                    />
                    ...
                    <ImageBackground
                        ...
                        <ScrollView
                            ...
                            <View
                                ...
                                <Text style={styles.labelText}>Please Enter a New Password</Text>
                                <Text style={styles.labelText}>
                                    Password must be 8~10 characters long
                                    Contain only alphanumeric characters
                                    Contain at least one number.
                                    Not contain spaces.
                                    Not be the same as your UserID.
                                    Not be the same as any of your past 10 passwords.
                                </Text>
