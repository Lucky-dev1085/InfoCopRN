...
const HeaderBar = ({ title, onLeftButton, leftIcon, rightIcon, onRightButton, backgroundColor, leftIconColor, titleColor = Constants.white, isBackLeft = false, isShowRight = true, isShowLeft = true, isTransparent = false }) => {
                    ...
                    <TouchableOpacity onPress={onLeftButton} style={styles.leftIcon}>
                        {
                            leftIcon != null ?
                                leftIcon : (
                                    isBackLeft ? <BackIcon size={25} color={'white'}/> :
                                        <MenuIcon size={35} color={leftIconColor ? leftIconColor : '#6733bb'}/>                                        
                                )
                        }
