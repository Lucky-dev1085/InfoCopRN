...
export default class DownloadModal extends React.Component {
    ...
    render() {
        const { showDownloadModal, onTapClose, onTapDownload,progress,disablebuttons} = this.props
        return (
            <Modal
                animationType="fade"
                transparent={true}
                ...
                <View
                    ...
                    <View
                        ...
                        <Text
                            ...
                            DOWNLOAD IS AVAILABLE. PLEASE ACCEPT TO DOWNLOAD
